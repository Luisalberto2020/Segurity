        ...
        if (sender instanceof Player player) {
            if (args.length == 1) {
                ...
                if(user.isPresent()) {
                    ...
                    if (PlayerConnected.intentosLogin.get(player.getName()) >=  5) {
